...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Julia Domingues", "juliadomingues@email.com.br", "12345678", "-"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario(0L, "Juliana Andrade", "juliana_andrade@email.com.br", "juliana123", "-"));
		
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Juliana Andrade Ramos", "juliana_ramos@email.com.br", "juliana123", "-");
	...
	public void deveMostrarTodosUsuarios() {
		...
		ResponseEntity<String> resposta = testRestTemplate
				.withBasicAuth("root@root.com", "rootroot")
				.exchange("/usuarios/todos-usuarios", HttpMethod.GET, null, String.class);
